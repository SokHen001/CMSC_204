...
public class CourseDBManager_STUDENT_Test {
    ...
    public void testShowAll() {
        ...
        assertEquals(list.get(0),"Course:PHYS161 CRN:21590 Credits:4 Room Number:LB032 Instructor:Dr. Max Nam");
        assertEquals(list.get(1),"Course:ENEE244 CRN:23531 Credits:4 Room Number:SC231 Instructor:Kam Yee");
        assertEquals(list.get(2),"Course:MATH282 CRN:32190 Credits:3 Room Number:SW205 Instructor:Penn Richard");
    }
